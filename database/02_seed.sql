...
-- Run after 01_schema.sql while connected to pdts_db
-- ============================================================
...
-- username: admin001
-- password: Admin@2025
INSERT INTO app_user (user_last_name, user_first_name, role_id, user_email_address, user_password_hash, user_username) VALUES
('Administrator', 'System', 3, 'admin@pup.edu.ph', '{noop}Admin@2025', 'admin001');
