...
-- ============================================================
-- Create/select the database first:
--   CREATE DATABASE pdts_db;
-- Then run this script while connected to pdts_db.
...
-- PostgreSQL treats USER as a special keyword, so the Java entity and schema use app_user.
...
-- Keep tracking sequence updated_at current when rows are updated.
